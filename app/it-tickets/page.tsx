...
export default function ITTicketsPage() {
  ...
  const { complaintStatuses, isLoading: statusesLoading } =
  ...
  const {
    ...
    queryFn: async () => {
      ...
      const response = await api.get(
        `/complaints/it${params.toString() ? `?${params.toString()}` : ""}`
      );
            ...
            <div className="w-[140px]">
              ...
              <Select value={statusId} onValueChange={setStatusId}>
                <SelectTrigger>
                  <SelectValue
                    placeholder={
                      statusesLoading ? "Loading..." : "All Statuses"
                    }
                  />
                </SelectTrigger>
                <SelectContent>
                  ...
                  <TableBody>
                    {currentData.map((ticket: Ticket) => (
                      <TableRow
                        ...
                        onClick={() =>
                          (window.location.href = `/it-tickets/${ticket.id}`)
                        }
                      >
                        <TableCell
                        ...
                        <TableCell
                          ...
                          title={ticket.categoryEntity?.type?.toUpperCase()}
                        >
